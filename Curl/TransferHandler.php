...
use Yjv\HttpQueue\Curl\CurlEvent;

use Symfony\Component\EventDispatcher\EventDispatcherInterface;

class TransferHandler implements RequestBodyReaderInterface, ResponseContentHandlerInterface
{
    ...
    protected function dispatch($eventName, CurlEvent $event)
    {
        if ($this->dispatcher) {
